...
insert into task (sort_order, question_type, created, updated, last_saved_by, heading, heading_reference, id, role_type, checklist_id, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (1, 'YES_OR_NO_WITH_TEXT', now(), now(), 'someUser', 'Description of first employee task', 'http://www.address-to-click.web', 'd250a20c-a616-4147-bfe0-19a0d12f3df0', 'NEW_EMPLOYEE', 'e20598a4-6b32-459e-8c15-febbd4c5868e', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Text for first employee task');
...
insert into task (sort_order, question_type, created, updated, last_saved_by, heading, heading_reference, id, role_type, checklist_id, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (9, 'YES_OR_NO', now(), now(), 'someUser', 'Description of task for dept 5536', 'http://www.address-to-click-for-5536-task.web', '368c4c0b-ccb9-443b-9e38-9da52f0b4b95', 'NEW_EMPLOYEE', '68849473-59aa-4ae6-b4bd-7f046e857984', 'd2c92810-3c46-4161-af54-7ae8b3c9d0b3', 'Text for dept 5536 task');
...
insert into task (sort_order, question_type, created, updated, last_saved_by, heading, heading_reference, id, role_type, checklist_id, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (2, 'YES_OR_NO', now(), now(), 'someUser', 'Description of managers manager task', 'http://www.manager-manager-task-address.web', 'e930c70d-a961-4b71-89b4-935d47db982f', 'MANAGER_FOR_NEW_MANAGER', '8c66e24b-3845-47ae-af74-c4611db8be7c', 'd2c92810-3c46-4161-af54-7ae8b3c9d0b3', 'Text for task to be performed by new managers manager');
...
values ('2024-07-01', '2024-10-01', '2024-01-01', false, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', NULL, '1810c9c4-7281-44de-9930-426d9f065f4d', 'f853e2b1-a144-4305-b05e-ee8d6dc6d005');
...
-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-06', '2024-10-06', '2024-01-06', false, '2024-01-06 12:00:00.000', '2024-01-06 12:00:00.000', NULL, '8122705b-e0e6-4055-b301-eba21986e219', 'f5960058-fad8-4825-85f3-b0fdb518adc5');
...
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'someUser', 'Custom employee task', '1b3bfe66-0e6c-4e92-a410-7c620a5461f4', 'f5960058-fad8-4825-85f3-b0fdb518adc5', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Descriptive text for custom task', 'YES_OR_NO', 'NEW_EMPLOYEE');
...
-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-06', '2024-10-06', '2024-01-06', false, '2024-01-06 12:00:00.000', '2024-01-06 12:00:00.000', NULL, 'ae93a63e-d975-4cd9-8e28-4cc9ea8b4d96', '2e2bb099-560c-450e-8f20-764498a37983');
...
-- Fulfilments
insert into fulfilment (updated, last_saved_by, id, employee_checklist_id, response_text, task_id, completed)
values ('2024-01-07 12:00:00.000', 'aman0agr', '6b17e790-f22c-46fe-8bff-f58af8cbab6a', '2e2bb099-560c-450e-8f20-764498a37983', 'Response on employee task performed by manager to new manager', 'c8c7abe0-5703-4ca1-86d3-74e5ad79b690', 'TRUE'),
       ('2024-01-07 12:00:00.000', 'cman1agr', 'c44c6fac-2875-468c-9112-e0a5a2646cb6', '2e2bb099-560c-450e-8f20-764498a37983', 'Response on employee task performed by new manager',            'a76e9920-261f-42fc-9077-14fb1cdb9871', 'TRUE'),
       ('2024-01-07 12:00:00.000', 'aman0agr', 'c44c6fac-2875-468c-1244-e0a5a2646cc6', '2e2bb099-560c-450e-8f20-764498a37983', 'Response on manager task performed by manager to new manager',  'e930c70d-a961-4b71-89b4-935d47db982f', 'TRUE'),
       ('2024-01-07 12:00:00.000', 'cman1agr', 'c44c6fac-2875-468c-5678-e0a5a2646cd6', '2e2bb099-560c-450e-8f20-764498a37983', 'Response on manager task performed by new manager',             '0da1dfa2-5196-45c2-b605-162a323b9b5e', 'TRUE');
...
-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-01', '2024-10-01', '2024-01-01', false, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', NULL, '702323a9-f542-4081-a780-a1396068c8c9', 'c179d5e1-0c5d-4eba-9f27-aca5011263c5');
...
-- Employee E
insert into employee (start_date, created, updated, organization_id, department_id, email, first_name, id, last_name, manager_id, title, username, employment_position)
values ('2024-01-01', now(), now(), 'cfcb03b1-7344-4352-9b72-7aebb1f235e1', 'bd49f474-303c-4a4e-aa54-5d4f58d9188b', 'e.employee@55351.com', 'E Emp', 'bfd69468-bd32-4b84-a3b0-c5e1742a5a34', 'Loyee', '9d2adcf6-9234-4faf-a6c9-0c1c7518b534', 'Struggler', 'eemp5loyee', 'EMPLOYEE');

-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-01', '2024-10-01', '2024-01-01', false, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', NULL, 'bfd69468-bd32-4b84-a3b0-c5e1742a5a34', '8fcc1fc7-bcda-4db6-9375-ff99961ef011');
...
-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-01', '2024-10-01', '2024-01-01', false, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', NULL, '87b0d9c2-c06e-409d-b77e-63f427e0dbc2', 'e4474a9b-1a57-49b8-bec8-2e50db600fbb');
...
insert into employee (start_date, created, updated, organization_id, department_id, email, first_name, id, last_name, manager_id, title, username, employment_position)
values ('2024-01-01', now(), now(), 'cfcb03b1-7344-4352-9b72-7aebb1f235e1', 'bd49f474-303c-4a4e-aa54-5d4f58d9188b', 'i.employee@55351.com', 'I Emp', '7bc7707c-2a82-44fb-bbf6-fe00f9ec11c6', 'Loyee', 'f59918bc-a8f1-4f97-abe3-9f80f26e6bf2', 'Muggler', 'iemp6loyee', 'EMPLOYEE');
...
-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-01', '2024-10-01', '2024-01-01', false, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', NULL, 'f1abc7a4-ad20-4c74-a5d7-3d4833405a96', '855e7d4e-af50-4fd3-b81d-a71299f38d1a');
...
insert into custom_task (sort_order, created, updated, last_saved_by, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'someUser', 'First custom employee task', '677a9efd-55bf-468d-81e8-efc913b9f956', '855e7d4e-af50-4fd3-b81d-a71299f38d1a', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Descriptive text for first custom task', 'YES_OR_NO', 'NEW_EMPLOYEE');

-- Custom task for manager
insert into custom_task (sort_order, created, updated, last_saved_by, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'someUser', 'First custom manager task', '0ef2b968-2b65-41d5-9865-e3e0d0f37e00', '855e7d4e-af50-4fd3-b81d-a71299f38d1a', '7272d1fc-540e-4394-afe2-e133ca642e91', 'Descriptive text for custom task', 'YES_OR_NO', 'MANAGER_FOR_NEW_EMPLOYEE');
...
-- Employee checklist
insert into employee_checklist (end_date, expiration_date, start_date, locked, created, updated, correspondence_id, employee_id, id)
values ('2024-07-01', '2024-10-01', '2024-01-01', false, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', NULL, 'd59ded65-bdf8-49e9-837d-3ca12be93970', '51ca9112-001b-4f12-b866-8d59ef1c25c4');
...
-- Custom task
insert into custom_task (sort_order, created, updated, last_saved_by, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'someUser', 'First custom employee task', '8b4eafc8-46ec-4fe3-9c2e-11625f144b10', '51ca9112-001b-4f12-b866-8d59ef1c25c4', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Descriptive text for first custom task', 'YES_OR_NO', 'NEW_EMPLOYEE');
