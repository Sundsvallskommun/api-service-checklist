...
VALUES ('1455a5d4-1db8-4a25-a49f-92fdd0c60a14', 'Phase name', 'Phase description of deprecated phase', 'P1W', 1, now(), now(), 'someUser', '1bc85739-cf6d-4223-b9dc-09218f044db7'),
       ('2455a5d4-1db8-4a25-a49f-92fdd0c60a14', 'Phase name', 'Phase description of active phase',     'P1W', 1, now(), now(), 'someUser', '2bc85739-cf6d-4223-b9dc-09218f044db7'),
-- Phases for checklist in test03
       ('11bf5015-2dda-4dd6-9129-797fa2868e56', 'Phase name', 'Phase description', 'P1W', 1, now(), now(), 'someUser', '83929b6a-c29e-4d95-9212-b02fb3f9b9cf'),
-- Phases for checklists in test04
       ('1e20a240-e1a6-458a-bcb0-572bfe345806', 'Phase name', 'Phase description', 'P1W', 1, now(), now(), 'someUser', '141896ee-6c32-4b53-8c81-3bae51a1ed05'),
       ('2e20a240-e1a6-458a-bcb0-572bfe345806', 'Phase name', 'Phase description', 'P1W', 1, now(), now(), 'someUser', '241896ee-6c32-4b53-8c81-3bae51a1ed05'),
-- Phases for checklist in test06
       ('784d3ce0-ade8-4241-8f50-1c93573b2303', 'Phase name', 'Phase description', 'P1W', 1, now(), now(), 'someUser', '3880efec-e66e-42a5-a3ac-ea2d08da0e5c'),
-- Phases for checklists in test07
       ('1fc59eb7-95b7-4323-899f-310762b1cdd7', 'Phase name', 'Phase description', 'P1W', 1, now(), now(), 'someUser', '1914e06d-5ca5-4ea7-9052-23228be56cca'),
       ('2fc59eb7-95b7-4323-899f-310762b1cdd7', 'Phase name', 'Phase description', 'P1W', 1, now(), now(), 'someUser', '2914e06d-5ca5-4ea7-9052-23228be56cca');
...
VALUES ('1af3e3c4-4b67-4f74-ae6e-dfde9a7cf934', 'Task name', 'Task description of deprecated task for employee', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '1455a5d4-1db8-4a25-a49f-92fdd0c60a14'),
       ('2af3e3c4-4b67-4f74-ae6e-dfde9a7cf934', 'Task name', 'Task description of active task for employee',     'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '2455a5d4-1db8-4a25-a49f-92fdd0c60a14'),
       ('ca8a7b75-bf90-45a5-a6dc-df66f5ce38d7', 'Task name', 'Task description of active task for new manager',  'NEW_MANAGER', 'YES_OR_NO', 1, now(), now(), 'someUser', '2455a5d4-1db8-4a25-a49f-92fdd0c60a14'),
-- Task for phase in test03
       ('cc7076b6-ffee-467a-870e-d1ba1ff1b892', 'Task name', 'Task description', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '11bf5015-2dda-4dd6-9129-797fa2868e56'),
-- Tasks for phases in test04
       ('1d1d4f38-9687-47b8-93e4-9fe133c08e9a', 'Task name', 'Task description', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '1e20a240-e1a6-458a-bcb0-572bfe345806'),
       ('2d1d4f38-9687-47b8-93e4-9fe133c08e9a', 'Task name', 'Task description', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '2e20a240-e1a6-458a-bcb0-572bfe345806'),
-- Task for phase in test06
       ('a7ce8ecd-5ff9-4b33-9d66-0870f3cd2ddd', 'Task name', 'Task description', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '784d3ce0-ade8-4241-8f50-1c93573b2303'),
-- Tasks for phases in test07
       ('1f78daa1-e83a-4523-8939-9a1a2ccdeb3c', 'Task name', 'Task description', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '1fc59eb7-95b7-4323-899f-310762b1cdd7'),
       ('2f78daa1-e83a-4523-8939-9a1a2ccdeb3c', 'Task name', 'Task description', 'NEW_EMPLOYEE', 'YES_OR_NO', 1, now(), now(), 'someUser', '2fc59eb7-95b7-4323-899f-310762b1cdd7');
