...
insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (1, 'YES_OR_NO', now(), now(), 'Description of manager task', 'e43fdac2-331e-4808-8d83-753a59e329cd', 'MANAGER', '7272d1fc-540e-4394-afe2-e133ca642e91', 'Text for manager task');

insert into phase (sort_order, created, updated, body_text, role_type, checklist_id, id, name, time_to_complete) -- role_type on phase defines if it is the new employee or his/hers boss that the target for the phase
values (2, now(), now(), 'Description of employee phase', 'EMPLOYEE', 'e20598a4-6b32-459e-8c15-febbd4c5868e', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Phasename', 'P1M');

insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (1, 'YES_OR_NO_WITH_TEXT', now(), now(), 'Description of first employee task', 'd250a20c-a616-4147-bfe0-19a0d12f3df0', 'EMPLOYEE', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Text for first employee task');

insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (2, 'YES_OR_NO', now(), now(), 'Description of second employee task', '0c8b99e9-718b-4c92-9ba3-a49dc29d48b5', 'EMPLOYEE', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Text for second employee task');

insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (3, 'YES_OR_NO', now(), now(), 'Description of manager task', '056423aa-01a4-4243-ace4-561a6e4cd25f', 'MANAGER', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Text for manager task');
...
insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (1, 'COMPLETED_OR_NOT_RELEVANT', now(), now(), 'Description of manager task', 'c8c7abe0-5703-4ca1-86d3-74e5ad79b690', 'MANAGER', '539b074d-d654-49ec-9dce-220f8a5ba7bb', 'Text for manager task');

insert into phase (sort_order, created, updated, body_text, role_type, checklist_id, id, name, time_to_complete) -- role_type on phase defines if it is the new employee or his/hers boss that the target for the phase
values (2, now(), now(), 'Description of employee phase', 'EMPLOYEE', '8c66e24b-3845-47ae-af74-c4611db8be7c', 'd2c92810-3c46-4161-af54-7ae8b3c9d0b3', 'Phasename', 'P1M');

insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (1, 'COMPLETED_OR_NOT_RELEVANT_WITH_TEXT', now(), now(), 'Description of employee task', 'a76e9920-261f-42fc-9077-14fb1cdb9871', 'EMPLOYEE', 'd2c92810-3c46-4161-af54-7ae8b3c9d0b3', 'Text for employee task');
...
insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (1, 'YES_OR_NO', now(), now(), 'Description of new manager task', '0da1dfa2-5196-45c2-b605-162a323b9b5e', 'EMPLOYEE', '638ad05e-3f90-4cb1-b26f-1f364469b386', 'Text for task to be performed by new manager');

insert into task (sort_order, question_type, created, updated, heading, id, role_type, phase_id, text) -- role_type on task defines if it is the new employee or his/hers boss that is targeted for the task
values (2, 'YES_OR_NO', now(), now(), 'Description of managers manager task', 'e930c70d-a961-4b71-89b4-935d47db982f', 'MANAGER', '638ad05e-3f90-4cb1-b26f-1f364469b386', 'Text for task to be performed by managers manager');
...
-- Custom task
insert into custom_task (sort_order, created, updated, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'Custom employee task', '1b3bfe66-0e6c-4e92-a410-7c620a5461f4', 'f5960058-fad8-4825-85f3-b0fdb518adc5', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Descriptive text for custom task', 'YES_OR_NO', 'EMPLOYEE');
...
insert into delegate (email, id, manager_id, employee_checklist_id, party_id, user_name, first_name, last_name)
...
insert into custom_task (sort_order, created, updated, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'First custom employee task', '677a9efd-55bf-468d-81e8-efc913b9f956', '855e7d4e-af50-4fd3-b81d-a71299f38d1a', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Descriptive text for first custom task', 'YES_OR_NO', 'EMPLOYEE');

-- Custom task in manager phase
insert into custom_task (sort_order, created, updated, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'First custom manager task', '0ef2b968-2b65-41d5-9865-e3e0d0f37e00', '855e7d4e-af50-4fd3-b81d-a71299f38d1a', '7272d1fc-540e-4394-afe2-e133ca642e91', 'Descriptive text for custom task', 'YES_OR_NO', 'MANAGER');
...
-- Custom task
insert into custom_task (sort_order, created, updated, heading, id, employee_checklist_id, phase_id, `text`, question_type, role_type)
values (0, '2024-01-03 12:00:00.000', '2024-01-03 12:00:00.000', 'First custom employee task', '8b4eafc8-46ec-4fe3-9c2e-11625f144b10', '51ca9112-001b-4f12-b866-8d59ef1c25c4', '3e9780a7-96f3-4d07-80ee-a9634b786a38', 'Descriptive text for first custom task', 'YES_OR_NO', 'EMPLOYEE');
