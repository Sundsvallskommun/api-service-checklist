...
public class Phase {
	...
	@Schema(description = "The sort order of the phase", examples = "1", accessMode = READ_ONLY)
	private int sortOrder;

	@ArraySchema(arraySchema = @Schema(implementation = Task.class, description = "Tasks in the phase", accessMode = READ_ONLY))
	private List<Task> tasks;

	@Schema(description = "The created date and time of the phase", examples = "2023-11-22T15:30:00+03:00", accessMode = READ_ONLY)
	@DateTimeFormat(iso = DATE_TIME)
	private OffsetDateTime created;

	@Schema(description = "The last update date and time of the phase", examples = "2023-11-22T15:30:00+03:00", accessMode = READ_ONLY)
	@DateTimeFormat(iso = DATE_TIME)
